...
ZooKeeper je navržen, tak aby jej bylo jednoduché použít. Struktura datového modelu je podobná stromovému uspořádání souborového systému. Je napsán v Javě a poskytuje konektory pro Javu a pro C.
