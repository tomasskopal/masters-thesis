...
\begin{figure}[H]
	\centering
    \includegraphics[width=.65\linewidth, height=.5\textheight]{images/app-architecture.png}
...
%%Bude zde také zmíněno dynamické nasazování nových ep pravidel.
\section{Testování}



%%Bude zde rozbor toho jaká pravidla jsou použita při iniciálním spuštěním a pro jemnozrnou analýzu a jaké jsou z toho výstupy
