...
Do kafky data zapisují \textit{producenti} a na druhé straně z ní data čtou \textit{konzumenti} (angl. producer and consumer).
...
\bibitem
Apache Kafka [online]. Dostupné z: \url{http://kafka.apache.org} \label{bib_5}
