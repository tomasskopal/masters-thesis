...
~/Downloads/jdk1.8.0_65/bin/java -jar main-app.jar -ip 147.251.43.129 -zklist 147.251.43.129:2181,147.251.43.130:2181,147.251.43.150:2181,147.251.43.138:2181 -m combined -p 147.251.43.129 > /dev/null &
echo $! > ~/app.pid
CONSUMER
sleep 10s
