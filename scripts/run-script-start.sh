...
cd masters-thesis/app/main-app/target
~/Downloads/jdk1.8.0_65/bin/java -jar main-app.jar -ip ${server} -zklist 147.251.43.129:2181,147.251.43.130:2181 -zkpath /147.251.43.129 -m producer -p 147.251.43.129 > /dev/null &
sleep 1s
echo \$! > ~/producer.pid
PRODUCER
done